...
<!--
YUI().use('console',"datatable", "datasource-get", "datasource-jsonschema", "datatable-datasource", function (Y) {
	
	    var url = "http://localhost:8080/cch5/instances?",
	        dataSource,
	        table;
