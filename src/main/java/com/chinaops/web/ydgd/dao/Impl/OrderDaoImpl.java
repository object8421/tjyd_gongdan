...
public class OrderDaoImpl {
	...
	public List<Order> selectOrderByProductType(String ticketIdS,String productType) {
		...
		try {
            ...
            order.setContractSignedDate(rs.getTimestamp("contract_signed_date"));
            order.setContractExpiredDate(rs.getTimestamp("contract_expired_date"));
            ...
            order.setCloseTime(rs.getTimestamp("close_time"));
            order.setResetTime(rs.getTimestamp("reset_time"));
